...
// Comment this out to use production main
// #define CHOOSE_TEST_MAIN

#define CHOOSE_TEST_CAMERA
...
#elif defined(CHOOSE_TEST_CAMERA)
// Prints a frame to serial.
// Copy paste the output (from BEGIN to END) into an image.hex file and run
// ./tools/dartcam_image.py to render it.
int main() {
    dartcam.init();
    int frame_count = 0;
    while (true) {
